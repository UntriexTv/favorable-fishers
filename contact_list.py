...
class ListView(Frame):
    def __init__(self, screen, model=None, x=0, y=0):
...
class ContactView(Frame):
    def __init__(self, screen, model, x=0, y=0):
...
def demo(screen, scene):
    scenes = [
        Scene([ListView(screen, contacts), ContactView(screen, contacts, x=screen.width//3)], -1, name="Main"),
