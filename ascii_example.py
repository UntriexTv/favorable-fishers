...
class ListView(Frame):
    def __init__(self, screen, model):
        ...
        self._edit_button = Button("Edit", self._edit, None)
        self._delete_button = Button("Delete", self._delete, None)
        ...
        layout2.add_widget(Button("Add", self._add, None), 0)
...
class ContactView(Frame):
    def __init__(self, screen, model):
        ...
        layout2 = Layout([1, 1, 1, 1])
        self.add_layout(layout2)
        layout2.add_widget(Button("OK", self._ok, None), 0)
        layout2.add_widget(Button("Cancel", self._cancel, None), 3)
        self.fix()
...
def demo(screen, scene):
    ...
    screen.play(scenes, stop_on_resize=True, start_scene=scenes[1], allow_int=True)


contacts = ContactModel()
last_scene = "Edit Contact"
while True:
    try:
